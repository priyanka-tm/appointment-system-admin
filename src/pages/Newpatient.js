...
const style = {
  ...
  const Newpatient = ({closeModal,openModal,props}) =>{
    ...
    return(
        ...
        <Modal
            ...
            <Box sx={style}>
              ...
              <Button variant="contained" style={{width:"100%" ,height:"10%",marginTop:"3%"}} onClick={saveUser}  disableElevation>Register</Button>
            </Box>
        </Modal>
        </>
    )
